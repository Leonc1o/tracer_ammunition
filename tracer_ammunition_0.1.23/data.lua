...
require("data/item/defender"); -- new
require("data/item/flamethrower.lua")
require("data/item/homing_ammo") -- new
require("data/item/rocket.lua")

-- recipe --

require("data/recipe/recipe");

-- script --
require("data/script/bullet/bullet_animation"); -- new
...
require("data/script/damage_type"); -- new
require("data/script/particles"); -- new
require("data/script/projectile")
