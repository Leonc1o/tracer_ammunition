        ...
        ammo_type =
        {
            ...
            action =
            {
                ...
                action_delivery =
                {
                    ...
                    starting_speed = 0.5, -- 0.1 = slow bullet start
                    direction_deviation = 0.15,
                    range_deviation = 0.15,
                    --max_range = 60, -- bullets doesnt seem to change to this range, maybe entiry-projectiles are locked to weapon range?
                    source_effects =
                    {
                        {
...
data:extend({
    {
        ...
        acceleration = 0.005,
        turn_speed = 0.003,
        turning_speed_increases_exponentially_with_projectile_speed = true, -- new, taken from Rockets
        --acceleration = 0.005,--0.005,-- -0.015, -- making the bullets accelerate as the same rate as rockets, for now
